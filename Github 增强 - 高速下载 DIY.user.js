// ==UserScript==
// @name         Github 增强 - 高速下载 DIY
// @name:zh-CN   Github 增强 - 高速下载 DIY
// @name:zh-TW   Github 增強 - 高速下載 DIY
// @name:en      Github Enhancement - High Speed Download DIY
// @version      2.4.11
// @author       Kevin
...
(function() {
    ...
    const download_url_us = [
        ...
        ['https://github.moeyy.xyz/https://github.com', 'Moeyy', '[新加坡、香港、日本等]（CDN 不固定） - 该公益加速源由 [Moeyy] 提供&#10;&#10; - 缓存：无（或时间很短）'],
        ...
        ['https://kkgithub.com', '新加坡', '[新加坡] - 该公益加速源由 [KGitHub] 提供&#10;&#10;提示：希望大家尽量多使用前面的美国节点（每次随机 4 个来负载均衡），&#10;避免流量都集中到亚洲公益节点，减少成本压力，公益才能更持久~'] // DNS 污染
    ], clone_url = [
